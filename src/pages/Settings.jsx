...
import { User, CreditCard, Gamepad2, Monitor, Shield, HelpCircle, LogOut, Gauge } from 'lucide-react';
...
export default function Settings() {
  ...
  // Settings categories (added performance)
    ...
    <TVLayout>
      <div className="h-full flex">
        ...
        <div className="flex-1 overflow-y-auto p-8 tv-scrollbar">
          ...
          {selectedTab !== 'profile' && selectedTab !== 'performance' && (
